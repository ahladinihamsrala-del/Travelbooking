...
public class HotelsSearchResultsPage extends BasePage {
	...
	//By bestPriceToggleSwitch=By.xpath("//span[@data-testid='bpg-toggle-switch']");
	...
	public List<Double> getListedPrices()
	{
		...
		List<Double> actualPrices = driver.findElements(pricesDispTxt).stream()
	...
	public boolean verifyFilters(String Local)
	{
	...
	By localitySearchTxt=By.xpath("//div[@data-testid='"+Local+"']");
	
	elementsUtil.doClickJSbyElementPresence(localitySearchTxt);
	...
	public HotelRoomDetailsPage bookHotel()
	{
		...
		String newTabHandle = WindowUtils.switchToNewTabAfterClick(
		    driver,
